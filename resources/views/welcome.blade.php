                    ...
                    <div class="">
                        ...
                        @php
                            if(isset($tipoUsuario) && $tipoUsuario == 1){
                                echo '<a href="/admin/dashboard" class="text-muted">Dashboard</a>';
                            }
                            else if(isset($tipoUsuario) && $tipoUsuario == 3){
                                echo '<a href="/usuario/inicio" class="text-muted">Dashboard</a>';
                            }
                        @endphp
                        @else
