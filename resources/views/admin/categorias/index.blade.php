...
@section('content')
    <div class="container-fluid">
        <h1 class="text-black-50">Categoria</h1>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">Tabla de categorias</div>
        ...
        <div class="card-body">
            <div class="col-12">
                <div class=" d-flex flex-row-reverse">
                    <a type="button" class="btn btn-primary my-3" href="{{ route('categorias.create') }}"> <i class="fas fa-plus"></i> Agregar</a>
                </div>
            </div>
